...
export function BoxSekeleton() {
    return (
        <div className="p-2 bg-white rounded-xl shadow-md">
            ...
            <div className="p-2 mt-2 space-y-1 bg-gray-100 rounded-md">
                ...
                <div className="text-sm font-bold w-68 h-5 bg-gray-200 rounded-md"></div>
            </div>
        </div>
    )
}
    ...
    return (
        <>
            <div className="flex justify-between items-center">
                ...
                <div className="hidden sm:block w-48 h-8 bg-gray-200 rounded-xl"></div>
            </div>
            <div className={`${shimmer} grid grid-cols-2 sm:grid-cols-3 gap-5 pt-4`}>
