        ...
        <>
            <div className="mx-auto max-w-7xl px-4 sm:px-0">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-7 py-7">
                    {arrImg.map((arr) => (
                        <div key={arr.id} className="p-2 bg-white rounded-xl shadow-md">
                            ...
                            <div className="flex space-x-1 bg-[var(--linear)] p-2 rounded-lg items-center">
                ...
                <div className="relative overflow-hidden grid sm:grid-cols-2 bg-[#FFB775] sm:gap-4 rounded-2xl mt-12 z-10">
                    ...
                    <div className="sm:px-5 sm:pt-7 flex justify-center order-2 sm:order-1">
                        <Image src='/bg.png' alt="banner" width={160} height={160} className="object-cover w-auto h-[342px]"></Image>
                    </div>
                    <div className="absolute w-[780px] h-[635px] rounded-[99px] rotate-[155deg] bg-[var(--linear)] translate-x-[-180px] translate-y-[-230px] -z-10"></div>
                    <div className="absolute w-[790px] h-[790px] rounded-[99px] rotate-[152deg] bg-[var(--dblue)] translate-x-[650px] translate-y-[150px] -z-10"></div>
                </div>
            </div>
        </>
    );
