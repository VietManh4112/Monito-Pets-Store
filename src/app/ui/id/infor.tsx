...
export default function InforPets() {
    ...
    const handleImg = (id: number) => {
        ...
        if (imgRefs.current[id]) {
            imgRefs.current[id].scrollIntoView({
                behavior: 'smooth',
                block: 'nearest',
                inline: 'center'
            });
    ...
    const showSvg = () => {
        if (svgRef.current) {
            svgRef.current.classList.remove('sm:opacity-0');
        }
    }

    const leaveImg = () => {
        if (svgRef.current) {
            svgRef.current.classList.add('sm:opacity-0');
        }
    }
        ...
        <>
            <div className="sm:grid grid-cols-2 gap-8 border rounded-3xl px-4 sm:px-5 py-6 tr">
                <div ref={divRef} className="overflow-hidden select-none opacity-0 duration-1000 ease-in-out">
                    ...
                    <div className="hidden sm:flex gap-4 items-center bg-[var(--linear)] rounded-xl px-3 py-2 text-[13px] font-bold">
                        <div className="flex items-center gap-2">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="30" height="30" fill="#FCEED5" />
                                <g clipPath="url(#clip0_108_1538)">
                    ...
                    <div className="hidden sm:flex mt-4 px-3 py-2 gap-5 items-center">
                        <div className="flex gap-2 text-[var(--dblue)] font-bold text-sm">
                ...
                <div className="space-y-5 sm:pr-7">
                    ...
                    <div>
                        <p className="font-medium text-sm text-gray-400">SKU #1000078</p>
                        <h1 className="font-bold text-2xl">Shiba Inu Sepia
                    ...
                    <div className="font-medium text-gray-600 text-sm">
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">SKU</p>
                            <p>:#1000078</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Gender</p>
                            <p>:Female</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Age</p>
                            <p>:2 Months</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Color</p>
                            <p>:Appricot & Tan</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Vaccinated</p>
                            <p>:Yes</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Vaccinated</p>
                        ...
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Dewomed</p>
                            <p>:Yes</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Cert</p>
                            <p>:Yes(MKA)</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Microchip</p>
                            <p>:Yes</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Location</p>
                            <p>:VietNam</p>
                        </div>
                        <div className="flex items-center border-b py-3">
                            <p className="px-3 w-[194px]">Published Date</p>
                            <p>:12-Oct-2022</p>
                        </div>
